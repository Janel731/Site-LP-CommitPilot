  ...
  return (
    ...
    >
      <div className="max-w-4xl">
        <span className="text-sm font-medium text-[#1B4FD8] ">Utilisation</span>
        ...
        <p className="mt-5 max-w-3xl text-base leading-relaxed text-[#3D3D4E] md:text-lg">
          ...
          <code className="mx-1 text-[#1B4FD8] ">commitpilot start</code>
        ...
        <div className="mt-8 overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950">
          ...
          <pre className="overflow-x-auto p-4 text-sm text-[#1B4FD8] md:p-6">
            {`commitpilot start`}
          </pre>
        </div>
        ...
        <div className="mt-10">
          <h3 className="text-xl font-semibold text-[#1E1E2E] ">
            Comment ça fonctionne ?
          </h3>

          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-zinc-800 bg-[#1E1E2E] p-5">
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-blue-500/10 text-blue-400">
                1
              </div>

              <h4 className="font-medium text-white">Analyse</h4>
            ...
            <div className="rounded-2xl border border-zinc-800 bg-[#1E1E2E] p-5">
              ...
              <h4 className="font-medium text-white">Génération IA</h4>

              <p className="mt-2 text-sm text-zinc-400">
                L'IA comprend les changements et rédige un message de commit
                pertinent.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-zinc-800 bg-[#1E1E2E] p-5">
              ...
              <h4 className="font-medium text-white">Commit</h4>
...
✓ Commit créé avec succès`}
        ...
        <div className="mt-8 rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
          <p className="text-sm text-emerald-400">
            ✓ Votre historique Git reste propre et cohérent sans avoir à rédiger
            manuellement vos commits.
          </p>
        </div>
      </div>
    </section>
